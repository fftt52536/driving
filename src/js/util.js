...
function initDefaultLighting(scene) {
    const ambientLight = new THREE.AmbientLight(0x282828); // 环境光，较暗的灰色光，增加整体的柔和感
    scene.add(ambientLight);
    /*
    var spotLight = new THREE.SpotLight(0xaaaaaa);
    spotLight.position.copy(new THREE.Vector3(100, 300, 0));
    ...
    spotLight2.position.copy(new THREE.Vector3(100, 300, 0));
    ...
    var hemisphereLight = new THREE.HemisphereLight(0x555555, 0x333333, 3);
    hemisphereLight.position.copy(new THREE.Vector3(0, 500, 0));
    ...
    */
    ...
    var pointLight = new THREE.PointLight(0xaaaa77);
    pointLight.position.copy(new THREE.Vector3(10, 300, 100))
